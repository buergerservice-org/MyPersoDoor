    ...
    std::string workflow::getkeypad()
    {
        ...
        try
        {
            ...
            */
            ...
            if (std::stoi(ver1) < 1 || std::stoi(ver2) < 20)
            {
                //std::cout << "AusweisApp2-version less 1.22.*, please update to new AusweisApp2!" << std::endl;
                std::cout << "AusweisApp2-version less 1.20.*, please update to new AusweisApp2!" << std::endl;
                if (ws.is_open()) {
                    ws.close(websocket::close_code::normal);
                    std::cout << "closed websocketconnection." << std::endl;
                }
            ...
            else
            {
                ...
                std::cout << "AusweisApp2-version equal or greater 1.20.*, ok we continue." << std::endl;
            }
